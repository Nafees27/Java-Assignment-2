...
public class Bank {
    ...
    {
        FileWriter fWriter = new FileWriter("/home/nafees/eclipse-workspace/Assignment/src/javaAssignment2/log");
        DateTimeFormatter dtf = DateTimeFormatter.ofPattern("yyyy/MM/dd HH:mm:ss");
        LocalDateTime now = LocalDateTime.now();
        fWriter.write("Current Balance : " + balance+ " Amount educted : "+ amt+" DATE and TIME "+ now+"\n");
        fWriter.close();
    }
